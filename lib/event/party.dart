...
class _PartyState extends State<Party> {
  ...
  init() async {
    ...
    setState(() {
      ...
      id = widget.party['customer']['id'];
      phone = widget.party['customer']['business_phone'];
      customer = widget.party['customer'];
      print(customer['business_logo']);
    });
  }
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 20),
                    // Customer information (business logo, name, etc.)
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                    ...
                    Text(
                      '${widget.party['space']} le ${widget.party['date']} à ${widget.party['hour']}',
